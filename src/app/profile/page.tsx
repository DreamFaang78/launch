...
//import an image from publicc folder
import Image from 'next/image'
import chacha from 'public/agams90.png';
    ...
    <div>
      ...
      <div className="flex flex-auto">
        <div className="flex flex-auto">
          ...
          <div>
          <div className="inline-grid-center px-11">
          <Image src={chacha} alt="chacha" height={400} width={300} className="padding-inline-center" />
